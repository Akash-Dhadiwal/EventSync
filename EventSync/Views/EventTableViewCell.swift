...
class EventTableViewCell: UITableViewCell {
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            // Pin wrapper to contentView (with small margins)
            ...
            // Event Image
            eventImageView.topAnchor.constraint(equalTo: wrapperCellView.topAnchor, constant: 5),
            eventImageView.leadingAnchor.constraint(equalTo: wrapperCellView.leadingAnchor, constant: 5),
            eventImageView.bottomAnchor.constraint(equalTo: wrapperCellView.bottomAnchor, constant: -5),
            eventImageView.widthAnchor.constraint(equalToConstant: 120),
            
            // Event Name
            eventNameLabel.leadingAnchor.constraint(equalTo: eventImageView.trailingAnchor, constant: 14),
            eventNameLabel.topAnchor.constraint(equalTo: wrapperCellView.topAnchor, constant: 20),
            eventNameLabel.trailingAnchor.constraint(equalTo: wrapperCellView.trailingAnchor, constant: -5),
            
            // Event Location
            eventLocationLabel.leadingAnchor.constraint(equalTo: eventImageView.trailingAnchor, constant: 14),
            eventLocationLabel.topAnchor.constraint(equalTo: eventNameLabel.bottomAnchor, constant: 6),
            
            // Event Date Time
            eventDateTimeLabel.leadingAnchor.constraint(equalTo: eventImageView.trailingAnchor, constant: 14),
            eventDateTimeLabel.topAnchor.constraint(equalTo: eventLocationLabel.bottomAnchor, constant: 6),
            
            // Event Like Label
            eventLikeLabel.trailingAnchor.constraint(equalTo: eventLikeImageView.leadingAnchor, constant: -4),
            eventLikeLabel.bottomAnchor.constraint(equalTo: eventLikeImageView.bottomAnchor),
            
            // Event Like Icon
            eventLikeImageView.trailingAnchor.constraint(equalTo: wrapperCellView.trailingAnchor, constant: -10),
            eventLikeImageView.bottomAnchor.constraint(equalTo: wrapperCellView.bottomAnchor, constant: -10),
            ...
            // Fixed cell height (if you want)
            wrapperCellView.heightAnchor.constraint(greaterThanOrEqualToConstant: 120)
        ])
    }
